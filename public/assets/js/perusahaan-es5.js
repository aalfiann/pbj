  ...
  template: function template(props) {
    if (props.table.length > 0) {
      return "<table class=\"table space-top\">\n          <thead>\n              <tr>\n              <th>#</th>\n              <th>NPWP</th>\n              <th>Nama Perusahan</th>\n              <th>Alamat</th>\n              <th>Kabupaten</th>\n              <th>Kodepos</th>\n              <th>Telepon</th>\n              <th>Fax</th>\n              <th>Email</th>\n              <th>Website</th>\n              <th>Bentuk Usaha</th>\n              <th>Jenis Usaha</th>\n              </tr>\n          </thead>\n          <tbody>\n              ".concat(props.table.map(function (item, index) {
        var num = index + 1;
        return "<tr>\n                  <td data-label=\"#\">".concat(num + (props.pageNow - 1) * props.itemPerPage, "</td>\n                  <td data-label=\"NPWP\">").concat(item.npwp, "</td>\n                  <td data-label=\"Nama Perusahaan\">").concat(item.bu_nama, "</td>\n                  <td data-label=\"Alamat\">").concat(item.bu_alamat, "</td>\n                  <td data-label=\"Kabupaten\">").concat(item.bu_kabupaten, "</td>\n                  <td data-label=\"Kodepos\">").concat(item.bu_kodepos, "</td>\n                  <td data-label=\"Telepon\">").concat(item.bu_telepon, "</td>\n                  <td data-label=\"Fax\">").concat(item.bu_fax, "</td>\n                  <td data-label=\"Email\">").concat(item.bu_email, "</td>\n                  <td data-label=\"Website\">").concat(item.bu_website, "</td>\n                  <td data-label=\"Bentuk Usaha\">").concat(item.bu_bentuk_badan_usaha, "</td>\n                  <td data-label=\"Jenis Usaha\">").concat(item.bu_jenis_badan_usaha, "</td>\n              </tr>");
